...
extern void prim_bytelen(PRIM_PROTOTYPE);
extern void prim_mbslen(PRIM_PROTOTYPE);
...
#define PRIMS_STRINGS_FUNCS prim_numberp, prim_stringcmp, prim_strcmp,        \
    prim_strncmp, prim_strcut, prim_strlen, prim_bytelen, prim_mbslen,        \
    prim_strcat, prim_atoi, prim_ansi_notify, prim_notify,                    \
    prim_notify_descriptor, prim_ansi_notify_descriptor,                      \
    ...
    prim_notify_descriptor_nocr, prim_base64decode

#define PRIMS_STRINGS_NAMES "NUMBER?", "STRINGCMP", "STRCMP",        \
    "STRNCMP", "STRCUT", "STRLEN", "BYTELEN", "MBSLEN",              \
    "STRCAT", "ATOI", "ANSI_NOTIFY", "NOTIFY",                       \
    "NOTIFY_DESCRIPTOR", "ANSI_NOTIFY_DESCRIPTOR",                   \
    "NOTIFY_EXCLUDE", "INTOSTR",                                     \
