...
char *array_jencode(stk_array *input, int flags, dbref player);
stk_array *jdecode_array(char *input, int flags, stk_array **errarr);
stk_array *array_jdecode(stk_array *input, int flags, stk_array **errarr);

#ifdef FILE_PRIMS

stk_array *jdecode_file(char *filename, int flags, stk_array **errarr);
int jencode_file(stk_array *input, char *filename, int flags, dbref player);
